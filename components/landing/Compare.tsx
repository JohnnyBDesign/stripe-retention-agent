  ...
  return (
    <section id="compare" className="border-y border-afterwhy-line bg-afterwhy-elevated scroll-mt-16">
      <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <h2 className="text-3xl font-bold text-afterwhy-paper mb-8 text-center">
          Why not SaveMRR?
        </h2>
        <div className="bg-afterwhy-ink border border-afterwhy-line rounded-card overflow-hidden max-w-3xl mx-auto">
