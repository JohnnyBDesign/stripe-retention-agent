        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-2xl">
            ...
            <p className="font-body text-subheading text-muted-foreground leading-relaxed mb-10 max-w-xl">
              See the revenue already walking out of Stripe — then approve the save and we send it. $99 includes email. Connect Stripe, not an ESP. Independent product, not made by Stripe.
            </p>
            ...
            <p className="font-mono text-label uppercase tracking-[0.05em] text-muted-foreground">
              You approve every save · We send it · Replies go to you
            </p>
          </div>
