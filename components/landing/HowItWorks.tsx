      ...
      <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {steps.map((step, i) => (
            <div
              key={i}
              className="border-2 border-line rounded-2xl p-6 hover:border-lime transition-colors bg-panel"
            >
              <div className="text-xs font-bold text-mute tracking-wider mb-2">
                {step.number}
              </div>
